    ...
    <body>
        <div class="container">
            <main class="login-form">
                    <form method="post" action="{{ url('/addTransaksiDepositUang') }}"  enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="card-body mb-0 p-1">  
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <label class="font-weight-bold mb-2 mt-2"><b>Jumlah Uang</b> </label>
                                                <input type='text' class="form-control mb-3"name="JUMLAH_UANG" placeholder="Masukkan Uang"
                                                autocomplete="off" />
